...
\title{Log Monitoring \& Alert System\\\large Cloud Computing Lab}
...
\section{Screenshots}
Screenshots captured from the HTML mockups \texttt{Screenshot1.html}, \texttt{Screenshot2.html}, and \texttt{Screenshot3.html}.

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{screenshots/Screenshot1.png}
  \caption{Overview dashboard with live metrics and throughput trends.}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{screenshots/Screenshot2.png}
  \caption{Anomaly detection view with spike analysis and timeline.}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{screenshots/Screenshot3.png}
  \caption{Alerting and service health status with escalation history.}
\end{figure}
